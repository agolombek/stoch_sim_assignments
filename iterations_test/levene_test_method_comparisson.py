# -*- coding: utf-8 -*-
"""
Created on Sun Nov 20 09:13:31 2022
...
for samp_size in sample_sizes:
    ...
    filename = "levene_method_comparison"+str(int(samp_size))+"samples"
    ...
    plt.tight_layout()
    # plt.savefig('graphs/leven_test_method_comparisson/'+filename+'.pdf')
    plt.show()