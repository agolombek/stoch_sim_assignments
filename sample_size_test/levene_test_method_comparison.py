# -*- coding: utf-8 -*-
"""
Created on Sun Nov 20 09:50:18 2022
...
for mandel_itr in mandelbrot_itr:
    ...
    for i in range(len(df_mc.columns)):
        ...
        mc_vs_lh.append(levene(areas_mc, areas_lh, center='mean')[1])
        mc_vs_o.append(levene(areas_mc, areas_o, center='mean')[1])
        lh_vs_o.append(levene(areas_lh, areas_o, center='mean')[1])
    ...
    filename = "levene_test_method_comparison"+str(int(mandel_itr))+"iterations"
    ...
    plt.tight_layout()
    plt.savefig('graphs/levene_test_method_comparison/'+filename+'.pdf')
    plt.show()