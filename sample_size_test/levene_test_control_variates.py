# -*- coding: utf-8 -*-
"""
Created on Sun Nov 20 09:56:55 2022
...
for mandel_itr in mandelbrot_itr:
    ...
    for method in methods:
        ...
        for i in range(len(df.columns)):
            ...
            p = levene(areas, areas_cv, center='mean')[1]
    ...
    filename = "levene_test_control_variates"+str(int(mandel_itr))+"Iterations"
    ...
    plt.tight_layout()
    plt.savefig('graphs/levene_test_control_variates/'+filename+'.pdf')
    plt.show()